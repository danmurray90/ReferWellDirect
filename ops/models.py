...
class AuditEvent(models.Model):
    ...
    object_type = models.CharField(
        max_length=100, blank=True, help_text="Type of object affected"
    )
    object_id = models.CharField(
        max_length=100, blank=True, help_text="ID of object affected"
    )
...
class SystemLog(models.Model):
    ...
    details = models.JSONField(
        default=dict, blank=True, help_text="Additional log details"
    )
    ...
    request_id = models.CharField(
        max_length=100, blank=True, help_text="Request ID for tracing"
    )
