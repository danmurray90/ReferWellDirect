...
class Payment(models.Model):
    ...
    payment_id = models.CharField(
        max_length=100, unique=True, help_text="External payment ID"
    )
    ...
    external_payment_id = models.CharField(
        max_length=100, blank=True, help_text="Stripe payment ID"
    )
    external_fee = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
...
class PaymentMethod(models.Model):
    ...
    external_method_id = models.CharField(
        max_length=100, blank=True, help_text="External method ID"
    )
