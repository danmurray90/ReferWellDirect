...
class NotificationPreference(models.Model):
    ...
    referral_update_method = models.CharField(max_length=10, choices=DeliveryMethod.choices, default=DeliveryMethod.IN_APP)
    matching_complete_method = models.CharField(max_length=10, choices=DeliveryMethod.choices, default=DeliveryMethod.IN_APP)
    invitation_method = models.CharField(max_length=10, choices=DeliveryMethod.choices, default=DeliveryMethod.ALL)
    response_method = models.CharField(max_length=10, choices=DeliveryMethod.choices, default=DeliveryMethod.IN_APP)
    appointment_method = models.CharField(max_length=10, choices=DeliveryMethod.choices, default=DeliveryMethod.ALL)
    system_method = models.CharField(max_length=10, choices=DeliveryMethod.choices, default=DeliveryMethod.IN_APP)
    reminder_method = models.CharField(max_length=10, choices=DeliveryMethod.choices, default=DeliveryMethod.EMAIL)
