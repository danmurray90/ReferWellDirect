...
urlpatterns = [
    ...
    path(
        "notifications/legacy/<uuid:notification_id>/",
        notification_detail,
        name="notification-detail-legacy",
    ),
    path(
        "notifications/legacy/<uuid:notification_id>/mark-read/",
        mark_notification_read,
        name="notification-mark-read-legacy",
    ),
    path(
        "notifications/legacy/stats/",
        notification_stats,
        name="notification-stats-legacy",
    ),
]
