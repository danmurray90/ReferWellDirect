...
from .serializers import (
    ...
    NotificationChannelSerializer, NotificationStatsSerializer,
    NotificationMarkReadSerializer, NotificationBulkActionSerializer
)
...
class NotificationViewSet(ModelViewSet):
    ...
    def bulk_action(self, request):
        ...
        serializer = NotificationBulkActionSerializer(data=request.data, context={'request': request})
        if serializer.is_valid():
...
class NotificationChannelViewSet(ModelViewSet):
    ...
    def deactivate(self, request, pk=None):
        ...
        return Response({'error': 'Failed to deactivate channel'}, status=status.HTTP_400_BAD_REQUEST)
