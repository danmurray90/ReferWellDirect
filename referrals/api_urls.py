...
urlpatterns = [
    ...
    path('bulk/assign-referrer/', views.bulk_assign_referrer, name='bulk-assign-referrer'),
    path('bulk/export/', views.bulk_export, name='bulk-export'),
    
    # Appointment Bulk Operations API endpoints
    path('bulk/appointments/update-status/', views.bulk_update_appointment_status, name='bulk-update-appointment-status'),
    path('bulk/appointments/reschedule/', views.bulk_reschedule_appointments, name='bulk-reschedule-appointments'),
    path('bulk/appointments/assign-psychologist/', views.bulk_assign_psychologist, name='bulk-assign-psychologist'),
    path('bulk/appointments/export/', views.bulk_export_appointments, name='bulk-export-appointments'),
    
    # Task Bulk Operations API endpoints
    path('bulk/tasks/update-status/', views.bulk_update_task_status, name='bulk-update-task-status'),
    path('bulk/tasks/assign-user/', views.bulk_assign_task_user, name='bulk-assign-task-user'),
]
