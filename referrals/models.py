...
class Referral(models.Model):
    ...
    # Service preferences
    service_type = models.CharField(max_length=10, choices=ServiceType.choices, default=ServiceType.NHS)
    ...
    # Patient preferences
    patient_preferences = models.JSONField(default=dict, blank=True, help_text="Patient's preferences and requirements")
    ...
    max_distance_km = models.PositiveIntegerField(default=50, help_text="Maximum distance in kilometers")
    ...
    # Audit fields
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='created_referrals')
...
class Candidate(models.Model):
    ...
    # Relationships
    referral = models.ForeignKey(Referral, on_delete=models.CASCADE, related_name='candidates')
    psychologist = models.ForeignKey(User, on_delete=models.CASCADE, related_name='candidate_referrals')
    
    # Status
    status = models.CharField(max_length=20, choices=Status.choices, default=Status.PENDING)
    
    # Matching scores
    similarity_score = models.FloatField(null=True, blank=True, help_text="Similarity score from matching algorithm")
    structured_score = models.FloatField(null=True, blank=True, help_text="Score from structured features")
    final_score = models.FloatField(null=True, blank=True, help_text="Final combined score")
    confidence_score = models.FloatField(null=True, blank=True, help_text="Calibrated confidence score")
    
    # Matching explanation
    matching_explanation = models.JSONField(default=dict, blank=True, help_text="Explanation of why this candidate was matched")
    ...
    # Response details
    response_notes = models.TextField(blank=True, help_text="Notes from psychologist's response")
...
class Appointment(models.Model):
    ...
    # Relationships
    referral = models.ForeignKey(Referral, on_delete=models.CASCADE, related_name='appointments')
    ...
    duration_minutes = models.PositiveIntegerField(default=60, help_text="Appointment duration in minutes")
    location = models.TextField(blank=True, help_text="Appointment location or video call details")
    modality = models.CharField(max_length=10, choices=Referral.Modality.choices, default=Referral.Modality.IN_PERSON)
    ...
    outcome_notes = models.TextField(blank=True, help_text="Notes about appointment outcome")
...
class Message(models.Model):
    ...
    # Relationships
    referral = models.ForeignKey(Referral, on_delete=models.CASCADE, related_name='messages', null=True, blank=True)
...
class Task(models.Model):
    ...
    # Relationships
    referral = models.ForeignKey(Referral, on_delete=models.CASCADE, related_name='tasks', null=True, blank=True)
