...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--test-matching", action="store_true", help="Test the matching system"
        )
    ...
    def create_sample_data(self):
        ...
        gp_user, created = User.objects.get_or_create(
            email="gp@test.com",
            defaults={"first_name": "Dr. John", "last_name": "Smith", "role": "gp"},
        )
        if created:
        ...
        for psych_data in psychologists_data:
            ...
            if created:
                ...
                self.stdout.write(
                    f"Created psychologist: {psychologist.user.get_full_name()}"
                )
    ...
    def test_matching(self):
        ...
        try:
            ...
            if not referral:
                raise CommandError(
                    "No referrals found. Run with --create-sample-data first."
                )
