...
class MatchingRunAdmin(admin.ModelAdmin):
    ...
    Matching run admin.
    """
    list_display = ('referral', 'status', 'candidates_found', 'candidates_shortlisted', 'candidates_invited', 'created_at')
    ...
    fieldsets = (
        ...
        ('Results', {'fields': ('candidates_found', 'candidates_shortlisted', 'candidates_invited')}),
...
class MatchingAlgorithmAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ('name', 'algorithm_type', 'version', 'accuracy', 'is_active', 'is_default', 'created_at')
...
class CalibrationModelAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ('name', 'calibration_type', 'version', 'brier_score', 'is_active', 'is_default', 'created_at')
...
class MatchingThresholdAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ('user_type', 'auto_threshold', 'high_touch_threshold', 'is_active', 'created_at')
    list_filter = ('user_type', 'is_active', 'created_at')
    ordering = ('user_type',)
    
    fieldsets = (
        ('Basic Info', {'fields': ('user_type', 'auto_threshold', 'high_touch_threshold')}),
